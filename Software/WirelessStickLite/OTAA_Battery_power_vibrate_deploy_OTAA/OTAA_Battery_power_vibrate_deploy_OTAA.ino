...
// #define DELOYING
// https://console.thethingsnetwork.org/applications/horsesforcourses/devices/dansdonkeytester
...
/* ABP para*/
uint8_t NwkSKey[] = { 0xEC, 0x80, 0x4E, 0x80, 0xD0, 0xEB, 0x1A, 0x51, 0x86, 0x64, 0xFB, 0xA4, 0x94, 0xD3, 0x51, 0x29 };
uint8_t AppSKey[] = { 0xA7, 0xCA, 0x18, 0xE9, 0x1F, 0x3A, 0x1C, 0x9E, 0xA2, 0x2C, 0xA2, 0xC5, 0x41, 0x40, 0xDE, 0x3E };
uint32_t DevAddr =  ( uint32_t )0x260152BF;
...
/*ADR enable*/
bool loraWanAdr = false; // set to false because we have a moving vehicle.
...
static void bring_data_together(int _appDataSize) {
  ...
  uint8_t *bytePtr = (uint8_t*)&locRecord;
  appDataSize = sizeof(locRecord) ;
    ...
    case DEVICE_STATE_SEND:
      {
        ...
        bring_data_together(sizeof(locRecord));
