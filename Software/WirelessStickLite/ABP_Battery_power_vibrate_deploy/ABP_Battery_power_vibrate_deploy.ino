...
//https://console.thethingsnetwork.org/applications/baglu-rhywyn-test/devices/baglu-test1
...
/* OTAA para*/
uint8_t DevEui[] = { 0x00, 0x14, 0x67, 0xDA, 0x7E, 0xE3, 0xF5, 0x2C };
uint8_t AppEui[] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x03, 0xE1, 0x94 };
uint8_t AppKey[] = { 0xAD, 0x28, 0xEC, 0x85, 0x0C, 0x86, 0x15, 0xAC, 0x03, 0x6A, 0xE5, 0xF4, 0x19, 0x79, 0x8D, 0xB4 };

/* ABP para*/
uint8_t NwkSKey[] = { 0xA3, 0x93, 0xE6, 0xD8, 0x83, 0xFC, 0x38, 0xCC, 0xC3, 0x23, 0xB9, 0xB2, 0xFF, 0x51, 0xB9, 0x09 };
uint8_t AppSKey[] = { 0x00, 0x1A, 0x9E, 0x20, 0x81, 0x37, 0x57, 0xE6, 0x70, 0xB8, 0xDC, 0x68, 0x3F, 0x98, 0xBE, 0xA0 };
uint32_t DevAddr =  ( uint32_t )0x2601121C;
